...
plt.figure(1)
plt.plot(np.full((np.size(actual_j_0),1),scale[4]),actual_j_0,'b.',label='10pc')
plt.plot(np.full((np.size(actual_j_1),1),scale[3]),actual_j_1,'g.',label='5pc')
plt.plot(np.full((np.size(actual_j_2),1),scale[2]),actual_j_2,'m.',label='2.5pc')
plt.plot(np.full((np.size(actual_j_3),1),scale[1]),actual_j_3,'b.',label='1.25pc')
plt.plot(np.full((np.size(actual_j_4),1),scale[0]),actual_j_4,'c.',label='0.625pc')
plt.yscale('log')
plt.xticks(np.array([1,2,3,4,5]), ('0.625', '1.25', '2.5', '5', '10') )
plt.xlabel('Characteristic Length $l$ (pc)')
plt.ylabel(r'Actual Specific Angular Momentum $(pc^2 \ Myr^{-1})$')
plt.title('Specific Actual Angular Momentum vs Characteristic Length')
...
plt.figure(2)
plt.plot(np.full((np.size(implied_j_0),1),scale[4]),implied_j_0,'b.',label='10pc')
plt.plot(np.full((np.size(implied_j_1),1),scale[3]),implied_j_1,'g.',label='5pc')
plt.plot(np.full((np.size(implied_j_2),1),scale[2]),implied_j_2,'m.',label='2.5pc')
plt.plot(np.full((np.size(implied_j_3),1),scale[1]),implied_j_3,'b.',label='1.25pc')
plt.plot(np.full((np.size(implied_j_4),1),scale[0]),implied_j_4,'c.',label='0.626pc')
plt.yscale('log')
plt.xticks(np.array([1,2,3,4,5]), ('0.625', '1.25', '2.5', '5', '10') )
plt.xlabel('Characteristic Length $l$ (pc)')
plt.ylabel(r'Implied Specific Angular Momentum $(pc^2 \ Myr^{-1})$')
plt.title('Specific Implied Angular Momentum vs Characteristic Length')
plt.legend(bbox_to_anchor=(1.25, 1.0))
...
plt.figure(3)
plt.loglog(actual_j_0,implied_j_0,'r.',label='10pc')
plt.loglog(actual_j_1,implied_j_1,'g.',label='5pc')
plt.loglog(actual_j_2,implied_j_2,'m.',label='2.5pc')
plt.loglog(actual_j_3,implied_j_3,'b.',label='1.25pc')
plt.loglog(actual_j_4,implied_j_4,'c.',label='0.625pc')
