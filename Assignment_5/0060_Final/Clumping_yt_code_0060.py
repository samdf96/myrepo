...
#Projection plots for Clumping Overlay
    ...
    prj.save('Clump_0060_ClumpSizing_' + str(clump_sizing) + '_Octant_' + str(i) + '.png')  #Saves Figures
...
np.savetxt("Angular_Momentum_0060_x_projection_clumpsize_{clump_sizing}.csv".format(clump_sizing=clump_sizing),
           angular_momentum_list_x_projection,
           delimiter=' & ', fmt='%.4g', newline=' \\\\\n')
np.savetxt("Angular_Momentum_0060_y_projection_clumpsize_{clump_sizing}.csv".format(clump_sizing=clump_sizing),
           angular_momentum_list_y_projection,
           delimiter=' & ', fmt='%.4g', newline=' \\\\\n')
np.savetxt("Angular_Momentum_0060_z_projection_clumpsize_{clump_sizing}.csv".format(clump_sizing=clump_sizing),
           angular_momentum_list_z_projection,
           delimiter=' & ', fmt='%.4g', newline=' \\\\\n')
...
plt.savefig("Ang_Mom_Specific_Comparison_0060_Clumpsizing_{clump_sizing}_X-LOS.pdf".format(clump_sizing=clump_sizing), bbox_inches='tight')
plt.savefig("Ang_Mom_Specific_Comparison_0060_Clumpsizing_{clump_sizing}_X-LOS.png".format(clump_sizing=clump_sizing), bbox_inches='tight')
plt.show()
...
plt.savefig("Ang_Mom_Specific_Comparison_0060_Clumpsizing_{clump_sizing}_Y-LOS.pdf".format(clump_sizing=clump_sizing), bbox_inches='tight')
plt.savefig("Ang_Mom_Specific_Comparison_0060_Clumpsizing_{clump_sizing}_Y-LOS.png".format(clump_sizing=clump_sizing), bbox_inches='tight')
plt.show()
...
plt.savefig("Ang_Mom_Specific_Comparison_0060_Clumpsizing_{clump_sizing}_Z-LOS.pdf".format(clump_sizing=clump_sizing), bbox_inches='tight')
plt.savefig("Ang_Mom_Specific_Comparison_0060_Clumpsizing_{clump_sizing}_Z-LOS.png".format(clump_sizing=clump_sizing), bbox_inches='tight')
plt.show() 
